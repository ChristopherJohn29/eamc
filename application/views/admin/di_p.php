<div class="content">
   ...
   <div class="container-fluid">
      ...
      <div id="obsoletion-di" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  <div class="modal-header">
                     <h4 class="modal-title" id="standard-modalLabel">Obsoletion Documented Information</h4>
                     <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                  <form id="obsoletionDocumentedInformationForm">
                  
                     <div class="row mb-2">
                        <div class="form-group col-md-8">
                              <input type="hidden" class="form-control" id="doc_id_obsoletion" required>
                              <input type="hidden" class="form-control" id="user_id_obsoletion" required>
                              <label for="document_title_obsoletion" class="form-label">Document Title</label>
                              <input type="text" class="form-control" id="document_title_obsoletion" required>
                              <ul class="parsley-errors-list filled hidden"><li class="parsley-required"></li></ul>
                        </div>
                        <div class="form-group col-md-4">
                              <label for="effectivity_date_obsoletion" class="form-label">Effectivity Date</label>
                              <input type="date" class="form-control" id="effectivity_date_obsoletion" required>
                              <ul class="parsley-errors-list filled hidden"><li class="parsley-required"></li></ul>
                        </div>
                     </div>
                     ...
                     <div class="row mb-2">
                        ...
                        <div class="form-group col-md-6">
                              <label for="doc_type_id_obsoletion" class="form-label">Document Type</label>
                              <select class="form-select" id="doc_type_id_obsoletion" name="doc_type_id_obsoletion" required>
                                 <option value=""></option>
                                 <?php
                                    foreach ($doctype as $key => $value) {
                                       echo '<option value="'.$value['id'].'">'.$value['doc_type_name'].'</option>';
                        ...
                        <div class="form-group col-md-6">
                              <label for="dep_id_obsoletion" class="form-label">Department / Unit</label>
                              <select class="form-select" id="dep_id_obsoletion" name="dep_id_obsoletion" required>
                                 <option value=""></option>
                                 <?php
                                    foreach ($department as $key => $value) {
                                       echo '<option value="'.$value['id'].'">'.$value['dep_name'].'</option>';
                     ...
                     <div class="row mb-2">
                        ...
                        <div class="form-group col-md-4">
                              <label for="sec_id_obsoletion" class="form-label">Section (if applicable)</label>
                              <select class="form-select" id="sec_id_obsoletion" name="sec_id_obsoletion" required>
                                 <option value=""></option>
                                 <?php
                                    foreach ($section as $key => $value) {
                                       echo '<option value="'.$value['id'].'" class="hidden" data-dep_id="'.$value['dep_id'].'">'.$value['section_name'].'</option>';
                        ...
                        <div class="form-group col-md-4">
                              <label for="doc_code_obsoletion" class="form-label">Document Code</label>
                              <input type="text" class="form-control" id="doc_code_obsoletion" name="doc_code_obsoletion" required>
                              <ul class="parsley-errors-list filled hidden"><li class="parsley-required"></li></ul>
                        </div>
                        <div class="form-group col-md-4">
                              <label for="revision_no_obsoletion" class="form-label">Revision No.</label>
                              <input type="text" class="form-control" id="revision_no_obsoletion" name="revision_no_obsoletion" required>
                              <ul class="parsley-errors-list filled hidden"><li class="parsley-required"></li></ul>
                        </div>
                     ...
                     <div class="row mb-2">
                        <div class="form-group col-md-12">
                              <label for="reason_obsoletion" class="form-label">Reason for Obsoletion</label>
                              <textarea class="form-control" id="reason_obsoletion" name="reason_obsoletion"></textarea>
                              <ul class="parsley-errors-list filled hidden"><li class="parsley-required"></li></ul>
                        </div>
                     </div>
                  </form>
                  ...
                  <div class="modal-footer">
                     <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancel</button>
                     <button type="button" class="btn btn-primary" id="obsoletionDI">Save</button>
                  </div>
               </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
      </div>
