   ...
   <div class="container-fluid">
               ...
               <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap gap-3">
                     <div class="d-flex align-items-center">
                        <div style="width: 30px; height: 20px; background-color: #f1f3fa; border: 1px solid #ddd; margin-right: 8px;"></div>
                        <span>Obsolete</span>
                     </div>
                  </div>
               </div>
      ...
      <div class="row">
         <div class="col-12">
            <div class="card">
               <div class="card-body">
                  <table id="di-obsolete-datatable" class="table dt-responsive nowrap w-100">
                     <thead>
                        <tr>
                           <th>ID</th>
