<div class="content">
   <div class="hidden" id="car_id" data-car_id="<?=$car_id?>"></div>
   <!-- Start Content-->
   <div class="container-fluid">
      ...
      <div id="add-car-issuance" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
         <div class="modal-dialog modal-xl">
               <div class="modal-content">
                  <div class="modal-header">
                     <h4 class="modal-title" id="standard-modalLabel">NC Defination</h4>
                     <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                  <form id="addCARFormIssuance">
                     ...
                     <div class="row mb-2">
                        <div class="form-group col-md-12">
                           ...
                           <select class="form-select issuance_of_nc" name="issuance_of_nc" disabled>
                     ...
                     <div class="row mb-2">
                        <div class="form-group col-md-12">
                           ...
                           <textarea class="form-control issuance_of_nc_remarks" rows="4" disabled></textarea>
                        </div>
                     </div>
      ...
      <div class="row">
         <div class="col-12">
            <div class="card">
               <div class="card-body">
                  <table id="ncdefinition-table" class="table dt-responsive nowrap w-100">
                     <thead>
                        <tr>
                           <th>Issued By</th>
                           <th>Registered By</th>
      ...
      <h2>Correction and Dealing with the Consequences</h2>
      <div class="row">
         <div class="col-12">
            <div class="card">
               <div class="card-body">
                  <table id="correction-table" class="table dt-responsive nowrap w-100">
                     <thead>
                        <tr>
                           <th>Issued By</th>
                           <th>Registered By</th>
      ...
      <h2>Root Cause Analyis and Corrective Action</h2>
      <div class="row">
         <div class="col-12">
            <div class="card">
               <div class="card-body">
                  <table id="rootcause-table" class="table dt-responsive nowrap w-100">
                     <thead>
                        <tr>
                           <th>Issued By</th>
                           <th>Registered By</th>
