var diList = {
    ...
    loadDiList: function(){
        ...
        $.ajax({
            type: 'POST',
            url: '../documentedinformation/getDIFormsReview', // Replace 'MyController' with your controller name
            data: {},
    ...
    editInit: function(){
        ...
        $('#editDI').click(function (e) {
            ...
            if (diList.validateEditForm()) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '../documentedinformation/updateFormsReview', // Replace 'MyController' with your controller name
                    data: data,
                    success: function (response) {
