var car = {
    ...
    load : function (){
        ...
        var car_id = jQuery('#car_id').data('car_id');

        $.ajax({
            type: 'POST',
            url: 'getCarByID', // Replace 'MyController' with your controller name
            data: {'car_id' : car_id},
            success: function (response) {
                if(response != 'null'){
                    $.each(JSON.parse(response), function (index, item) {
                        ...
                        var htmlncdefinition = "<tr><td></td><td></td><td></td><td>" + 
                        "<a class='btn btn-success edit-car' data-status='"+status+"' data-requestor='" + requestor + "'  data-findings='" + findings + "' data-consequences='" + consequences + "' data-requirements_not_fulfilled='" + requirements_not_fulfilled + "' data-issuance_of_nc_remarks='" + issuance_of_nc_remarks + "' data-issuance_of_nc='" + issuance_of_nc + "' data-car_id='" + car_id + "' data-car_no='" + car_no + "' data-source='" + source + "' data-section='" + section + "' data-issued_by='" + issued_by + "' data-issued_to='" + issued_to + "' data-identification_date='" + identification_date + "' data-registration_date='" + registration_date + "' data-bs-toggle='modal' data-bs-target='#add-car-issuance'>View Details</a>" +
                        "</td></tr>";
                        

                        var htmlcorrection = "<tr><td></td><td></td><td></td><td></td><td></td><td>" + 
                        "<a class='btn btn-success edit-car' data-status='"+status+"' data-requestor='" + requestor + "'  data-findings='" + findings + "' data-consequences='" + consequences + "' data-requirements_not_fulfilled='" + requirements_not_fulfilled + "' data-issuance_of_nc_remarks='" + issuance_of_nc_remarks + "' data-issuance_of_nc='" + issuance_of_nc + "' data-car_id='" + car_id + "' data-car_no='" + car_no + "' data-source='" + source + "' data-section='" + section + "' data-issued_by='" + issued_by + "' data-issued_to='" + issued_to + "' data-identification_date='" + identification_date + "' data-registration_date='" + registration_date + "' data-bs-toggle='modal' data-bs-target='#add-car-issuance'>View Details</a>" +
                        "</td></tr>";

                        var htmlrootcause = "<tr><td></td><td></td><td></td><td></td><td></td><td>" + 
                        "<a class='btn btn-success edit-car' data-status='"+status+"' data-requestor='" + requestor + "'  data-findings='" + findings + "' data-consequences='" + consequences + "' data-requirements_not_fulfilled='" + requirements_not_fulfilled + "' data-issuance_of_nc_remarks='" + issuance_of_nc_remarks + "' data-issuance_of_nc='" + issuance_of_nc + "' data-car_id='" + car_id + "' data-car_no='" + car_no + "' data-source='" + source + "' data-section='" + section + "' data-issued_by='" + issued_by + "' data-issued_to='" + issued_to + "' data-identification_date='" + identification_date + "' data-registration_date='" + registration_date + "' data-bs-toggle='modal' data-bs-target='#add-car-issuance'>View Details</a>" +
                        "</td></tr>";
                        // Do something with the data, for example, display it on the page
                        $('#ncdefinition-table tbody').append(htmlncdefinition);
                        $('#correction-table tbody').append(htmlcorrection);
                        $('#rootcause-table tbody').append(htmlrootcause);
    ...
    carEdit: function(){
        ...
        $('#correction-table').on('click', '.edit-car', function () {
        ...
        $('#ncdefinition-table').on('click', '.edit-car', function () {
            $car_id = jQuery(this).data('car_id');
            $requestor = jQuery(this).data('requestor');
            $car_no = jQuery(this).data('car_no');
            $source = jQuery(this).data('source');
        ...
        $('#rootcause-table').on('click', '.edit-car', function () {
            $car_id = jQuery(this).data('car_id');
            $requestor = jQuery(this).data('requestor');
            $car_no = jQuery(this).data('car_no');
            $source = jQuery(this).data('source');
