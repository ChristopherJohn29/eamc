            ...
            success: function (response) {
                if(response != 'null'){
                    $.each(JSON.parse(response), function (index, item) {
                        ...
                        var updateUser = "<button type='button' data-bs-toggle='modal' data-bs-target='#update-user' title='Update User'  tabindex='0' data-plugin='tippy' data-tippy-theme='gradient' class='btn btn-success waves-effect waves-light data-update' data-id='"+id+"'><i class='feather feather-users'></i></button>"; 
