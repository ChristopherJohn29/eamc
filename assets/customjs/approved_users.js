            ...
            success: function (response) {
                if(response != 'null'){
                    $.each(JSON.parse(response), function (index, item) {
                        ...
                        var approved_by_user = item.approved_by_user ? item.approved_by_user : "";
                        ...
                        var html = "<tr><td>" + fullname + "</td><td>" + username + "</td><td>" + email + "</td><td>" + mobile_number + "</td><td>" + designation + "</td><td>" + division_name + "</td><td>" + department_name + "</td><td>" + department_section_name + "</td><td>" + role_name + "</td><td>" + approved_by_user + "</td><td>"+approved_date+"</td><td>"+ updateUser +"<button type='button' title='Deny'  tabindex='0' data-plugin='tippy' data-tippy-theme='gradient' class='btn btn-sm btn-danger waves-effect waves-light data-deny' data-id='"+id+"'><i class='mdi mdi-close'></i></button></td></tr>";
