var newUsers = {
    ...
    loadnewUsers: function(){

        dataTable = $('#new-users-datatable.dataTable');
        ...
        $('#new-users-datatable tbody').html('');
        

        $.ajax({
            type: 'POST',
            url: 'getNewUsers', // Replace 'MyController' with your controller name
            data: {},
            success: function (response) {
                if(response != 'null'){
                    $.each(JSON.parse(response), function (index, item) {
                        ...
                        var department_section_name = item.department_section_name ? item.department_section_name : '';
    ...
    approveInit: function(){
        jQuery('#new-users-datatable').on('click','.data-approve', function(){

            var user_id = jQuery(this).data('id');

            var result = confirm("Are you sure you want to proceed approving this User?");
            ...
            if (result) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'approve', // Replace 'MyController' with your controller name
                    data: {user_id : user_id},
                    success: function (response) {
                        // Handle the response from the server
                        if(response == 'saved'){
                            newUsers.notifyApprove();
                            newUsers.loadnewUsers();
                        } else {
                            newUsers.notifyError();
                        }
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response == 'saved'){
                            ...
                            window.location.href = '/admin/users/newUsers';
    ...
    dataUpdate: function(){
        $('#new-users-datatable').on('click', '.data-update', function () {
