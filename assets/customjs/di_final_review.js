var diList = {
    ...
    loadDiList: function(){
        ...
        $.ajax({
            type: 'POST',
            url: '../documentedinformation/getDIFinalReview', // Replace 'MyController' with your controller name
            data: {},
            success: function (response) {
                if(response != 'null'){
                    $.each(JSON.parse(response), function (index, item) {
                        ...
                        if(status == 'FIR'){
                            $action_button = "<button title='Final Review'  tabindex='0' data-plugin='tippy' data-tippy-theme='gradient' type='button' class='btn btn-sm btn-blue edit-data'"+
    ...
    editInit: function(){
        ...
        $('#editDI').click(function (e) {
            ...
            if (diList.validateEditForm()) {
                ...
                var final_review = jQuery('#final_review').val();
                var final_review_remarks = jQuery('#remarks').val();
                ...
                var data = {
                    ...
                    final_review_remarks: final_review_remarks
                };
                ...
                $.ajax({
                    type: 'POST',
                    url: '../documentedinformation/updateFinalReview', // Replace 'MyController' with your controller name
                    data: data,
                    success: function (response) {
