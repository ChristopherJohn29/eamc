            ...
            success: function (response) {
                if(response != 'null'){
                    $.each(JSON.parse(response), function (index, item) {
                        ...
                        $('#division-datatable tbody').append("<tr><td>"+id+"</td><td>"+div_name+"</td><td>"+created_by_email+"</td><td>"+created_date+"</td><td>"+last_updated_by_email+"</td><td><button title='Edit'  tabindex='0' data-plugin='tippy' data-tippy-theme='gradient' type='button' class='btn btn-sm btn-warning waves-effect waves-light edit-data' data-id='"+id+"' data-div_name='"+div_name+"'><i class='mdi mdi-file'></i></button><button type='button' title='Delete'  tabindex='0' data-plugin='tippy' data-tippy-theme='gradient' class='btn btn-sm btn-danger waves-effect waves-light data-delete' data-id='"+id+"'><i class='mdi mdi-close'></i></button></td></tr>");
                    });
