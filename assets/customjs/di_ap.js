var diList = {
    ...
    loadDiList: function(){
        ...
        $.ajax({
            type: 'POST',
            url: '../documentedinformation/getDIApprovalForPublishing', // Replace 'MyController' with your controller name
            data: {},
            success: function (response) {
                if(response != 'null'){
                    $.each(JSON.parse(response), function (index, item) {
                        ...
                        if(status == 'AFP'){
                            $action_button = "<button title='Approval For Publishing'  tabindex='0' data-plugin='tippy' data-tippy-theme='gradient' type='button' class='btn btn-sm btn-blue edit-data'"+
    ...
    editInit: function(){
        ...
        $('#editDI').click(function (e) {
            ...
            if (diList.validateEditForm()) {
                ...
                var approval_for_publishing = jQuery('#approval_for_publishing').val();
                var approval_for_publishing_remarks = jQuery('#remarks').val();
                ...
                var data = {
                    ...
                    approval_for_publishing: approval_for_publishing,
                    approval_for_publishing_remarks: approval_for_publishing_remarks
                };
                ...
                $.ajax({
                    type: 'POST',
                    url: '../documentedinformation/updateApprovalForPublishing', // Replace 'MyController' with your controller name
                    data: data,
                    success: function (response) {
